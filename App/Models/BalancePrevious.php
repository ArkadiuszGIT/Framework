 ...
 * PHP version 7.0
 */
class BalancePrevious extends \Core\Model
{
	public static function getUsersIncomes()
    {
		...
		$stmt->bindValue(':firstday', date("Y-m-01",strtotime("-1 month")), PDO::PARAM_STR);
		$stmt->bindValue(':lastday', date("Y-m-31",strtotime("-1 month")), PDO::PARAM_STR);
